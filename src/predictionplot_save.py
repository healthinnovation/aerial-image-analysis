...
from lib.loss import BCEDiceLoss
...
# Class to evaluate
classFolder = "non_vegetated/"

#Paths 
<<<<<<< HEAD
csvFileTest = "../data/experiment_non_vegetated_000/test_01.csv"
pathOutputPrediction= "../results/prediction_non_vegetated_4_folds_512/"

folderImagePathRoot = '../../dataset_512x512/'
fileNetworkWeights="../results/results-exp-000/non_vegetated_512x512/exp_CGIAR_non_vegetated/exp_CGIAR_non_vegetated_test_00_cv_01_patchSize_512.pt"
=======
csvFileTest = "../data/experiment_non_vegetated_000/test_00.csv"
pathOutputPrediction= "../results/prediction_non_vegetated_4_folds_512/"

folderImagePathRoot = '../../512x512/'
fileNetworkWeights="../results/non_vegetated_512x512/exp_CGIAR_non_vegetated/exp_CGIAR_non_vegetated_test_00_cv_01_patchSize_512.pt"
...
if __name__ == '__main__':
    ...
    model = Unet(inchannels=3, outchannels=1, net_depth=5)
    model.to(device)
