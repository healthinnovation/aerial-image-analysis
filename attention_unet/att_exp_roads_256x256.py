...
def train_pytorch_model():
    ...
    full_img = Image.open(os.path.join('..', '..', 'dataset_256x256', '2018_11_13_1__pissy_mos', 'roads', 'patches', 'patch_0000.png'))
    ...
    full_mask = Image.open(os.path.join('..', '..', 'dataset_256x256', '2018_11_13_1__pissy_mos', 'roads', 'masks', 'mask_0000.png'))
...
if __name__ == '__main__':
    ...
    cross_test = '00'
    exp_split_folder = '../data/experiment_roads_000'
    ################# DATA parameters  ####################################
    ...
    ref_image_path = os.path.join(main_data_dir, '2018_11_13_1__pissy_mos', 'roads', 'patches', 'patch_0000.png')
    ...
    path_to_logs = os.path.join('..', '..', 'heat_experiments_roads', exp_name)
