...
<<<<<<< HEAD
        ...
        ###########################
        # This is only for crops: #
        ###########################
        if len(imgs_dirs) > 20000:
            imgs_dirs = imgs_dirs[:int(len(imgs_dirs)/50)]
            masks_dirs = masks_dirs[:int(len(masks_dirs)/50)]
        ###########################
...
=======
        ...
        # This is only for crops: #
        ###########################
        if len(imgs_dirs) > 10000:
            imgs_dirs = imgs_dirs[:int(len(imgs_dirs)/10)]
            masks_dirs = masks_dirs[:int(len(masks_dirs)/10)]
        ###########################
