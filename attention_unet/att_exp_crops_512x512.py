...
def train_pytorch_model():
    ...
    full_img = Image.open(os.path.join('..', '..', 'dataset_512x512', '2018_11_13_1__pissy_mos', 'crops', 'patches', 'patch_0000.png'))
    ...
    full_mask = Image.open(os.path.join('..', '..', 'dataset_512x512', '2018_11_13_1__pissy_mos', 'crops', 'masks', 'mask_0000.png'))
...
if __name__ == '__main__':
    ...
    cross_test = '00'
    exp_split_folder = '../data/experiment_crops_000'
    ################# DATA parameters  ####################################
    ...
    ref_image_path = os.path.join(main_data_dir, '2018_11_13_1__pissy_mos', 'crops', 'patches', 'patch_0000.png')
    ...
    path_to_logs = os.path.join('..', '..', 'heat_experiments_crops', exp_name)
