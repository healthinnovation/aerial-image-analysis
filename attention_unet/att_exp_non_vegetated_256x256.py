...
def train_pytorch_model():
    ...
    full_img = Image.open(os.path.join('..', '..', 'dataset_256x256', '2018_11_13_1__pissy_mos', 'non_vegetated', 'patches', 'patch_0000.png'))
    ...
    full_mask = Image.open(os.path.join('..', '..', 'dataset_256x256', '2018_11_13_1__pissy_mos', 'non_vegetated', 'masks', 'mask_0000.png'))
    ...
    for epoch in range(n_epoch):
        ...
        for batch in tqdm(train_loader):
            ...
            with torch.no_grad():
                ...
                d4_out_pil = np.array(d4_out_pil.resize((256, 256)))
...
if __name__ == '__main__':
    ...
    main_data_dir = os.path.join('..', '..', 'dataset_256x256')
