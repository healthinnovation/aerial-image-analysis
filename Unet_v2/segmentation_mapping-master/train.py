...
def main():
    ...
    arg('--dataset-path', type=str, default='../../data_Unetv2', help='main file,in which the dataset is:  data_VHR or data_HR')
    ...
    arg('--train-val-file', type=str, default='train_val', help='name of the train-val file VHR:train_val_160 or train_val_512' )
    arg('--test-file', type=str, default='test', help='name of the test file test_512 or test_160' )
...
#################################
    ...
    print("Train_val length:", len(train_val_file_names))
    ...
    print("train file", str(data_path/data_all))    
   ...
   # print("train file maxs:"),
    #print(max_values,mean_values, std_values)

    mean_values = [0.54585896, 0.48385978, 0.36893278]
    std_values = [0.1609929,  0.14131174, 0.14937931]
